...
CREATE TYPE public.notice_priority AS ENUM ('urgent', 'important', 'regular');
...
CREATE TABLE public.notices (
  ...
  priority notice_priority NOT NULL DEFAULT 'regular',
...
-- Faculty policies (public read, admin write)
...
-- Notices policies (public read active, admin write)
...
-- Inquiries policies (anyone can insert, admins can read/delete)
